...
int main(int argc, char **argv)
{
	   ...
	   freeling::tokenizer tk(L"tokenizer.dat");
		...
		char ArchivoPalabrasIngles[200]; 
		char ArchivoDiccIngles[200]; 
		
		strcpy(ArchivoPalabrasIngles, "PalabrasIngles.txt");
		
		strcpy(ArchivoDiccIngles, "DiccIngles.txt");
		
		ImportPalabrasATraducir(&listado, ArchivoPalabrasIngles);

		ImportPalabrasATraducir(&dicc, ArchivoDiccIngles);
